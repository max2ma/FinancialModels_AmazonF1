...
int main(int argc, char** argv)
{
    ...
    auto kernelFunctor = cl::KernelFunctor<cl::Buffer,cl::Buffer,data_t,data_t,data_t,data_t,data_t>(kernel);
    ...
    cl::Event event = kernelFunctor(enqueueArgs, d_call,d_put, Params::time, Params::rate, Params::volatility, Params::initprice, Params::strikeprice);
