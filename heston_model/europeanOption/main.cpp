...
int main(int argc, char** argv)
{
    ...
    auto kernelFunctor = cl::KernelFunctor<cl::Buffer,cl::Buffer,data_t,data_t,data_t,data_t,data_t,data_t,data_t,data_t,data_t>(kernel);
    ...
    cout << "Starting execution. Time=" << Params::time
	    ...
	    << endl;
#ifdef PURE_C
    KERNEL_NAME(h_call, h_put, Params::theta, Params::kappa, Params::xi, Params::rho, Params::time, Params::rate, Params::volatility, Params::initprice, Params::strikeprice);
#else
