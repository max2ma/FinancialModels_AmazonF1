...
int main(int argc, char** argv)
{
	...
	try {
		...
		auto kernelFunctor = cl::KernelFunctor<cl::Buffer,cl::Buffer,float,float,float,float,float,float,float,float,float,float,float,int, int, int>(kernel);
