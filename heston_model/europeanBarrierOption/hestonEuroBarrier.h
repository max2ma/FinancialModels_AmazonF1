...
extern "C"
void hestonEuroBarrier(data_t *pCall, data_t *pPut, data_t expect, data_t kappa, data_t variance, data_t correlation, data_t timeT, data_t freeRate, data_t volatility, data_t initPrice, data_t strikePrice, data_t upB, data_t lowB);
#endif
